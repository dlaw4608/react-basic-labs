...
function App() {
  ...
  const [ taskState, setTaskState ] = useState({
    tasks: [
      ...
      { id: 4, title: "Clean Windowns", description:"Clean all of the upstair windows", deadline: "Thursday"},
      { id: 5, title: "Wash Dog", description:"Wash and Dry the Dog", deadline: "Tonight"}
    ]
  });
  return (
